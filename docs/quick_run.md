...
```shell
python tools/train2017.py -n yolox-s -d 8 -b 64 --fp16 -o [--cache] --logger wandb wandb-project <project name>
                         yolox-m
                         yolox-l
                         yolox-x
```
...
```shell
python tools/train2017.py -f exps/default/yolox-s.py -d 8 -b 64 --fp16 -o [--cache]
