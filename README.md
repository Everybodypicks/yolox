...
```shell
python -m yolox.tools.train2017 -n yolox-s -d 8 -b 64 --fp16 -o [--cache]
                               yolox-m
                               yolox-l
                               yolox-x
```
...
```shell
python -m yolox.tools.train2017 -f exps/default/yolox_s.py -d 8 -b 64 --fp16 -o [--cache]
...
```shell
python tools/train2017.py -n yolox-s -b 128 --dist-url tcp://123.123.123.123:12312 --num_machines 2 --machine_rank 0
```
On the second machine, run
```shell
python tools/train2017.py -n yolox-s -b 128 --dist-url tcp://123.123.123.123:12312 --num_machines 2 --machine_rank 1
```

**Others**  
See more information with the following command:
```shell
python -m yolox.tools.train2017 --help
```
